...
In this test we used Neural Networks that were learned using the same automatically generated learning set. The we check the performance by playing $1000$ games and compering the results to random player scores. 
